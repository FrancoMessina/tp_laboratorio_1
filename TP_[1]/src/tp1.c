...
int main(void) {
	...
	do
	{
		...
		{
			case 1:
				flagPrimerNumero = ingresarNumeroFlotante("Ingresa el Primer Número : ",&numeroUno);
			break;
			case 2:
				flagSegundoNumero = ingresarNumeroFlotante("Ingresa el Segundo Número :",&numeroDos);
			break;
			case 3:
